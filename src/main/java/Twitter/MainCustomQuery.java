...
public class MainCustomQuery{
    ...
    public static void userInteraction(Engine engine){
        System.out.println("Geben Sie hier ein Statement ein und betätigen Sie Enter oder lassen Sie die Zeile leer, " + "um das Standardstatement zu verwenden. Für Hilfe geben Sie 'help' ein:");
        String eingabe = "";
        try{
